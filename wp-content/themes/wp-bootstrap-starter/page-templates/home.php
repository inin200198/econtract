...
<main>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <div class="txt-banner">
                                    <h2 class="wow fadeInDown wHighlight" data-wow-delay=".2s">Ký hợp đồng từ xa, Doanh
                                        nghiệp quẳng mối ‘Lo xa’.</h2>
                                    <div class="desc wow fadeInUp wHighlight" data-wow-delay=".2s">FPT cung cấp miễn phí
                                        dịch vụ ký hợp đồng từ xa cho doanh nghiệp trong 3 tháng</div>
                                    <div class="btn-banner wow fadeInUp wHighlight" data-wow-delay=".3s">
                                        <ul>
                                            <li><a href="" class="btn-main-blue">Dùng thử miễn phí 3 tháng</a></li>
                                            <li><a href="" class="btn-main-gray">Gọi tư vấn cho tôi </a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="avar text-center wow fadeInRight wHighlight" data-wow-delay=".2s"><img
                                        src="<?php bloginfo( 'stylesheet_directory' ); ?>/assets/images/banner.jpg" class="img-fluid" alt=""></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="content-video">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="txt-video">
                            <h3 class="desc wow fadeInUp wHighlight" data-wow-delay=".2s">FPT.eContract -giao kết thông
                                minh, an ninh, mọi lúc</h3>
                            <div class="info-txt-video">
                                <div class="item-txt-video wow fadeInUp wHighlight" data-wow-delay=".2s">
                                    <div class="icon"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/assets/images/icon-video-1.png" class="img-fluid" alt=""></div>
                                    <div class="info">
                                        <h4>Ký kết thông minh</h4>
                                        <ul>
                                            <li>Doanh nghiệp, tổ chức quản lý việc khởi tạo, điều chỉnh, phê duyệt và
                                                lưu trữ hợp đồng/hồ sơ trên một nền tảng duy nhất</li>
                                            <li>Xác minh đối tác trực tuyến dễ dàng với eKYC.</li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="item-txt-video wow fadeInUp wHighlight" data-wow-delay=".2s">
                                    <div class="icon"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/assets/images/icon-video-2.png" class="img-fluid" alt=""></div>
                                    <div class="info">
                                        <h4>Mọi lúc, mọi nơi, mọi chữ ký</h4>
                                        <ul>
                                            <li>Cần là ký trong vài phút</li>
                                            <li>Ký trên máy tính bàn, máy tính bảng, di động</li>
                                            <li>Ký với mọi loại chữ ký số: token, HSM, chữ ký số dùng một lần, chữ ký
                                                điện tử cho </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="iframe-video">
                            ...
                            <iframe width="498" height="280" src="https://www.youtube.com/embed/qbGMXKzBwwo"
    ...
    <section class="box-number-hot">
        ...
        <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <div class="item-number-top">
                            <div class="icon"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/assets/images/number-1.png" class="img-fluid" alt=""></div>
                            <div class="info">
                                <h4><span class="count counter-value" data-count="350"></span>+</h4>
                                <div class="desc">Doanh nghiệp sử dụng</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <div class="item-number-top">
                            <div class="icon"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/assets/images/number-2.png" class="img-fluid" alt=""></div>
                            <div class="info">
                                <h4><span class="count counter-value" data-count="500"></span><span>.000+</span></h4>
                                <div class="desc">Hợp đồng hồ sơ được ký kết</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="number-bott">
                <div class="row">
                    <div class="col-md-3 col-6 col-sm-6  wow fadeInUp wHighlight" data-wow-delay=".2s">
                        <div class="item-nb text-center">
                            <div class="icon"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/assets/images/i-nb-1.png" class="img-fluid" alt=""></div>
                            <div class="desc">
                                <h4>0 đồng</h4>
                                <p>Phí in ấn, chuyển lưu trữ hợp đồng</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-6 col-sm-6 wow fadeInUp wHighlight" data-wow-delay=".25s">
                        <div class="item-nb text-center">
                            <div class="icon"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/assets/images/i-nb-2.png" class="img-fluid" alt=""></div>
                            <div class="desc">
                                <h4>0 đồng</h4>
                                <p>Thời gian chuyển giao, trình ký HĐ</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-6 col-sm-6 wow fadeInUp wHighlight" data-wow-delay=".3s">
                        <div class="item-nb text-center">
                            <div class="icon"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/assets/images/i-nb-3.png" class="img-fluid" alt=""></div>
                            <div class="desc">
                                <h4>0 đồng</h4>
                                <p>Cập nhật ngay tiến độ ký HĐ</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-6 col-sm-6 wow fadeInUp wHighlight" data-wow-delay=".35s">
                        <div class="item-nb text-center">
                            <div class="icon"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/assets/images/i-nb-4.png" class="img-fluid" alt=""></div>
                            <div class="desc">
                                <h4>0 đồng</h4>
                                <p>Không rủi ro thất lạc</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="box-step">
        <div class="container">
            <div class="title-price text-center wow fadeInUp wHighlight" data-wow-delay=".2s"> Số hoá quy trình ký hợp
                đồng</div>
            <div class="list-step">
                <div class="row">
                    <div class="col-md-3 wow fadeInLeft wHighlight" data-wow-delay=".3s">
                        <div class="item-step">
                            <span class="numb-step">1</span>
                            <h3 class="text-center">Người quản lý hợp đồng</h3>
                            <div class="icon-avr"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/assets/images/step-1.png" class="img-fluid" alt=""></div>
                            <div class="desc">
                                <ul>
                                    <li>Upload file hợp đồng</li>
                                    <li>Xác định luồng và thứ tự người xem xét/ký</li>
                                    <li>Xác định vị trí ký</li>
                                    <li>Gửi hợp đồng</li>
                                    <li>Hệ thống tạo luồng ký tự</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 wow fadeInLeft wHighlight" data-wow-delay=".25s">
                        <div class="item-step">
                            <span class="numb-step">2</span>
                            <h3 class="text-center">Người xem xét, duyệt nội dung</h3>
                            <div class="icon-avr"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/assets/images/step-2.png" class="img-fluid" alt=""></div>
                            <div class="desc">
                                <ul>
                    ...
                    <div class="col-md-3 wow fadeInLeft wHighlight" data-wow-delay=".2s">
                        <div class="item-step">
                            <span class="numb-step">3</span>
                            <h3 class="text-center">Người ký cuối</h3>
                            <div class="icon-avr"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/assets/images/step-3.png" class="img-fluid" alt=""></div>
                            <div class="desc">
                                <ul>
                                    <li>Nhận email thông báo tự động</li>
                                    <li>Thực hiện ký số (chữ ký số, ký hình vẽ...) mà không cần tài khoản vào hệ thống
                                    </li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 wow fadeInLeft wHighlight" data-wow-delay=".15s">
                        <div class="item-step">
                            <span class="numb-step">4</span>
                            <h3 class="text-center">Các bên ký hợp đồng</h3>
                            <div class="icon-avr"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/assets/images/step-4.png" class="img-fluid" alt=""></div>
                            <div class="desc">
                                <ul>
                                    <li>Hệ thống gửi thông báo hoàn tất ký hợp đồng đến các bên</li>
                                    <li>Hợp đồng được lưu trữ và mã hoá</li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <section class="box-juridical">
        ...
        <div class="container">
            <div class="content-juridical">
                <div class="icon wow fadeInUp wHighlight" data-wow-delay=".2s"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/assets/images/juridical.png"
                        class="img-fluid" alt=""></div>
                <div class="info">
                    <h3 class=" wow fadeInUp wHighlight" data-wow-delay=".2s">Pháp lý hợp đồng điện tử</h3>
                    <ul>
                        <li class=" wow fadeInUp wHighlight" data-wow-delay=".2s">
                            ...
                            <span>Luật giao dịch điện tử số 51/2005/QH11 ngày 29/11/2005 quy định về giao dịch điện tử
                                trong lĩnh vực dân sự, kinh doanh, thương mại và các lĩnh vực khác.</span>
                        </li>
                        <li class=" wow fadeInUp wHighlight" data-wow-delay=".2s">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class=" wow fadeInUp wHighlight" data-wow-delay=".2s">
                            ...
                            <span>Bộ Luật Lao động 2019 ghi nhận hình thức hợp đồng lao động điện tử</span>
                        </li>
                    </ul>
                </div>
            </div>
