        ...
        <div class="container">
            ...
            <div class="slide-casestudy dot-circle">
                <div class="item-slide">
                    <div class="item-case">
                        <div class="avarta"><a href=""><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/assets/images/case-1.png" class="img-fluid w-100" alt=""></a></div>
                        <div class="info">
                ...
                <div class="item-slide">
                    <div class="item-case">
                        <div class="avarta"><a href=""><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/assets/images/case-2.png" class="img-fluid w-100" alt=""></a></div>
                        <div class="info">
                            <h3><a href="">Ký kết hợp đồng điện tử lĩnh vực hàng không</a></h3>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="list-news">
                        <div class="item-news">
                            <div class="avarta"><a href=""><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/assets/images/new.jpg" class="img-fluid w-100" alt=""></a></div>
                            <div class="info">
