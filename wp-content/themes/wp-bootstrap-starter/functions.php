...
function wp_bootstrap_starter_scripts() {
	// wp_enqueue_style( 'wp-bootstrap-starter-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'wp-bootstrap-starter-style', 'rtl', 'replace' );

	wp_enqueue_script( 'wp-bootstrap-starter-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
...
setcookie('qtrans_front_language', 'vi', time() + (86400 * 30), get_option('home')); 
